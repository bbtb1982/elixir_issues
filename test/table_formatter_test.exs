defmodule TableFormatterTest do
  ...
  def split_with_three_colunms, do: TF.split_into_columns(simple_test_data, headers)

  test "split_into_columns" do
      columns = split_with_three_colunms
      assert    length(columns)     == length(headers)
      assert    List.first(columns) == ["r1 c1", "r2 c1", "r3 c1", "r4 c1"]
      assert    List.last(columns)  == ["r1 c3", "r2 c3", "r3 c3", "r4 c3"]
  end 

  test "correct fromat string returned" do
